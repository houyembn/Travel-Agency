...
if(isset($_GET['id_tour'])){
    $res=$detailtCtr->getDetail_tour($_GET['id_tour']);
?>
<?php } ?>
    ...
    <input type="text" name="pays" placeholder="donner les villes à visiter" id="pays" class="box" required>
...
<section class="edit-form-container">
    ...
    <img src="uploaded_img/<?php echo $res['image0']; ?>" height="200" alt="">
        ...
        <input type="text" class="box" name="name" value="<?php echo $res['pays'] ?>">
        <input type="text" class="box" name="descr" value="<?php echo $res['ville'] ?>">
        <input type="text" class="box" name="price" value="<?php echo $res['price'] ?>">
...
function   getDetail_tour($id_tour){
